...
1. You need to create a human-computer interface that uses _natural language_ to answer customer questions.  
Which product option should you select as a candidate?
...
1. You need to identify the content of product images to automatically create alt tags for images formatted properly.  

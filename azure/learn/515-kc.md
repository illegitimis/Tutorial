...
Then choose the best response for each question that follows and select Check your answers [1].
...
1. How can the IT department **reduce the number of times users must authenticate** to access multiple applications?
...
[1]: https://docs.microsoft.com/en-us/learn/modules/secure-access-azure-identity-services/5-knowledge-check

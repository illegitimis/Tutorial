...
1. A company wants to quickly manage its individual IoT devices by using a web-based user interface.  
...
1. You want to send messages from the IoT device to the cloud and vice versa.  

...
1. Tailwind Traders wants to use Azure ExpressRoute to connect  
...
1. Which of the following options can you use to link virtual networks?
...
1. Which of the following options _isn't_ a benefit of ExpressRoute?

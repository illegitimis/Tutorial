...
> Microsoft Docs: 7 Knowledge Check [1]
...
1. What's the easiest way for Tailwind Traders to *combine security data*  
...
1. Which is the best way for Tailwind Traders to *safely store its certificates*  
...
1. How can Tailwind Traders ensure that **certain VM workloads**
...
[1]: https://docs.microsoft.com/en-us/learn/modules/protect-against-security-threats-azure/7-knowledge-check

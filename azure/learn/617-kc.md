...
1. What's the best way to ensure that the development team doesn't provision too many virtual machines at the same time?
...
1. Which is the most efficient way for the testing team to save costs on virtual machines on weekends, when testers are not at work?
...
1. Resources in the Dev and Test environments are each paid for by different departments.  

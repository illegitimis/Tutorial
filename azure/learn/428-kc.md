...
1. What's the best way for Tailwind Traders to **limit all outbound traffic** from VMs to known hosts?
...
1. How can Tailwind Traders most easily implement a **deny by default policy**  

...
Recall that you can access SLAs from Service Level Agreements [1].
...
- [X] 99.9 percent  
Correct.  
The SLA for Azure Maps [2] tells you the SLA.
- [ ] 99.99 percent

1. What's the new composite SLA?  
...
1. Adding a third virtual machine reduces the composite SLA.  
...
1. What approach might the company take in adding the augmented reality (AR) preview service to its architecture?
...
[1]: https://azure.microsoft.com/support/legal/sla/
[2]: https://azure.microsoft.com/support/legal/sla/azure-maps?azure-portal=true

...
- usage guidelines by JBogard blog [2]
- Getting along with `AutoMapper` and `Autofac` article [3]
- Configuring `AutoMapper` to fulfil `ITypeConverter<,>` constructor dependecies with `Autofac`
so [4]
- AutoMapper, Autofac, Web API, and Per-Request Dependency Lifetime Scopes article [5]
...
[4]: https://stackoverflow.com/questions/40293597/configuring-automapper-to-fulfil-itypeconverter-constructor-dependecies-with

...
- Introduction to authorization in ASP.NET Core [2]
- ASP.NET Core Authorization with Barry Dorrans [3] channel9, 2016
- blowdart/AspNetAuthorizationWorkshop [4] github src
- Extending Identity Accounts and Implementing Role-Based Authentication in ASP.NET MVC 5 [5] nov13
- Claims-based authorization in ASP.NET Core [6] 2.1
- Authorize [7] attribute
...
[4]: https://github.com/blowdart/AspNetAuthorizationWorkshop
[5]: http://johnatten.com/2013/11/11/extending-identity-accounts-and-implementing-role-based-authentication-in-asp-net-mvc-5/

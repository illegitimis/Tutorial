...
> From <geekswithblogs.net: C.Net Fundamentals Choosing The Right Collection Class.Aspx [1]>
...
* `TreeSet` <referencesource.microsoft.com [2]>. `TreeSet` extends a `SortedSet`. Reference to parent node. `SortedSet.Node` is red black.
...
* <referencesource.microsoft.com [3]>
...
> From <referencesource.microsoft.com [4]>

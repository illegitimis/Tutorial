...
- [BASE](./base.md) — **BASE** properties: Basic Availability, Soft state, and Eventual consistency
- [CAP Theorem](./cap.md) — **CAP theorem** (Eric Brewer): Consistency, Availability, and Partition tolerance trade-offs
- [Azure Cosmos DB](./cosmos.md) — `Azure Cosmos DB` multi-model, schema-free, globally distributed database

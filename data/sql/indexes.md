...
- A heap is a table without a clustered index [6]. Heaps have one row in sys.partitions [7], with index_id = 0 for each partition used by the heap.  
...
[4]: https://technet.microsoft.com/en-us/library/ms177443(v=sql.105).aspx
